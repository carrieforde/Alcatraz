...
(function($) {
  ...
  wp.customize('alcatraz_options[header_style]', function(value) {
    value.bind(function(to) {
      $body.removeClass(
        'header-style-default header-style-short header-style-side'
      );
  ...
  wp.customize('alcatraz_options[mobile_nav_toggle_style]', function(value) {
    value.bind(function(to) {
      $body.removeClass(
        'mobile-nav-toggle-style-hamburger mobile-nav-toggle-style-button'
      );
  ...
  wp.customize('alcatraz_options[mobile_nav_style]', function(value) {
    value.bind(function(to) {
      $body.removeClass(
        'mobile-nav-style-default mobile-nav-style-slide-left mobile-nav-style-slide-right mobile-nav-style-full-screen'
      );
  ...
  wp.customize('alcatraz_options[sub_menu_toggle_style]', function(value) {
    value.bind(function(to) {
      $body.removeClass(
        'sub-menu-toggle-style-chevron sub-menu-toggle-style-plus-minus'
      );
