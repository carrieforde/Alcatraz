  ...
  (function (e, n) {
    ...
    function p() {
      var e = s();e !== o && (o = e, r.trigger(i));
        ...
        l,
        c,
        h;if (e.support.orientation) {
      l = t.innerWidth || r.width(), c = t.innerHeight || r.height(), h = 50, u = l > c && l - c > h, a = f[t.orientation];if (u && a || !u && !a) f = { "-90": !0, 90: !0 };
    }e.event.special.orientationchange = e.extend({}, e.event.special.orientationchange, { setup: function setup() {
        if (e.support.orientation && !e.event.special.orientationchange.disabled) return !1;o = s(), r.bind("throttledresize", p);
      }, teardown: function teardown() {
        if (e.support.orientation && !e.event.special.orientationchange.disabled) return !1;r.unbind("throttledresize", p);
      }, add: function add(e) {
        var t = e.handler;e.handler = function (e) {
          return e.orientation = s(), t.apply(this, arguments);
        };
      } }), e.event.special.orientationchange.orientation = s = function s() {
      var r = !0,
          i = n.documentElement;return e.support.orientation ? r = f[t.orientation] : r = i && i.clientWidth / i.clientHeight < 1.1, r ? "portrait" : "landscape";
    }, e.fn[i] = function (e) {
    ...
    var r = { animation: {}, transition: {} },
        i = n.createElement("a"),
        s = ["", "webkit-", "moz-", "o-"];e.each(["animation", "transition"], function (n, o) {
      var u = n === 0 ? o + "-" + "name" : o;e.each(s, function (n, s) {
      ...
      var u,
        ...
        clearTimeout(u), i.apply(this, arguments);
          ...
          c = !s || s === "animation" ? "animation" : "transition";if (e.support.cssTransitions && c === "transition" || e.support.cssAnimations && c === "animation") {
        if (o === t) {
          e(this).context !== n && (a = parseFloat(e(this).css(r[c].duration)) * 3e3);if (a === 0 || a === t || isNaN(a)) a = e.fn.animationComplete.defaultDuration;
...
var AlcatrazNavigation = function ($) {
  ...
  var initListToggle = function initListToggle(el, options) {
    ...
    return $(el).each(function () {
      ...
      var toggle = '<button type="button" class="sub-level-toggle">' + '<span class="screen-reader-text">' + safeToggleText + '</span>' + '<span class="sub-level-toggle-span span-1"></span>' + '<span class="sub-level-toggle-span span-2"></span>' + '</button>';
